...
MIC_POSITIONS_UNIT = [[-1, -1], [1, -1], [-1, 1], [1, 1]] # relative mic positions, normalized.
MIC_POSITIONS = [[MIC_D / 2 * m for m in mics] for mics in MIC_POSITIONS_UNIT] # relative mic positions (meters)
