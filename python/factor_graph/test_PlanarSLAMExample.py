...
class TestPlanarSLAM(GtsamTestCase):
    def test_PlanarSLAM(self):
        ...
        print("pose_1", result.atPose2(1))
        print("pose_2", result.atPose2(2))
        print("pose_3", result.atPose2(3))
        print("pose_4", result.atPose2(4))
        print("pose_5", result.atPose2(5))
        print("gtsam.Pose2()", gtsam.Pose2())
