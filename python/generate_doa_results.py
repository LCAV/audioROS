...
def simulate_doa(
    ...
    for (
        ...
        print(f"linear velocity {linear_velocity_cm} of {linear_velocity_cm_list}")
        print(f"angular velocity {angular_velocity_deg} of {angular_velocity_deg_list}")
...
if __name__ == "__main__":
    ...
    degree_noise_list = [0]
    offset_noise_list = [0]
    time_noise_list = np.logspace(-6, 0, 10)
    n_samples = 2
