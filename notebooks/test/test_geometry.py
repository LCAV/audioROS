    ...
    for distance in context.get_possible_distances(): 
        for azimuth_deg in np.arange(0, 360, step=15):
            ...
            for mic_idx in range(n_mics):
                ...
                delta = context.get_delta(azimuth_deg=azimuth_deg, distances_cm=distance * 1e2, mic_idx=mic_idx)
                distance_source_m = context.get_source_distance(delta, azimuth_deg, mic_idx)
